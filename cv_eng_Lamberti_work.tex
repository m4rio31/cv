...
\cventry{2020--present}{Associate Member of the ATLAS Collaboration at CERN (Geneva)}{}{Currently I am working in the $H \rightarrow \gamma\gamma$ cross-sections working group within the ATLAS Collaboration. This work is part of an analysis aimed at publishing an article by the ATLAS Collaboration.}{}{}
...
\cvitem{Languages \small{(advanced)}}{python, \LaTeX}
\cvitem{Languages \small{(intermediate)}}{C++, bash, XML, SQL, MySQL}
\cvitem{Languages \small{(basic)}}{Mathematica, JavaScript, HTML4/5, CSS}
\cvitem{Tools \& frameworks}{ROOT, RDataFrame, PyROOT, RooFit, Jupyter Notebook, HTCondor, Python VirtualEnv, Numpy, Pandas, Matplotlib, Git}
